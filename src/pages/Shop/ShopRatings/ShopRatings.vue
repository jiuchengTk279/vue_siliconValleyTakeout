      ...
      <div class="ratings-content">
        ...
        <div class="ratingselect">
          ...
          <div class="switch" :class="{on: onlyShowText}" @click="toggleOnlyShowText">
            <span class="iconfont iconduihao3"></span>
            <span class="text">只看有内容的评价</span>
          </div>
        </div>
        <div class="rating-wrapper">
          <ul>
            <li class="rating-item" v-for="(rating, index) of filterRatings" :key="index">
              <div class="avatar">
              ...
              <div class="content">
                ...
                <div class="recommend">
                  <span class="iconfont" :class="rating.rateType===0 ? 'iconzan' : 'iconquxiaozan'"></span>
...
export default {
  ...
  data () {
    return {
      ...
      selectType: 2 // 选择的评价类型  0为满意， 1为不满意， 2为全部的
    }
  },
  components: {
    Star
  ...
  computed: {
    ...
    filterRatings () {
      ...
      return shopRatings.filter(rating => {
        ...
        // 条件1   全部  满意  不满意
        // selectType: 0/1/2  rateType: 0/1  selectType===2 || selectType===rateType
        // 条件2   显示文本  不显示文本
        // onlyShowText: true/false   text: 有值/无值  !onlyShowText ||  text.length>0
