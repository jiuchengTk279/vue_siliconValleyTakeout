    ...
    <div class="shop-info">
      <div class="info-content">
        ...
        <section class="section">
          ...
          <div class="activity">
            <div class="activity-item" v-for="(support, index) of shopInfo.supports" :key="index" :class="supportClass[support.type]">
        ...
        <section class="section">
          ...
          <div class="pic-wrapper">
            <ul class="pic-list" ref="picList">
              <li class="pic-item" v-for="(pic, index) of shopInfo.pics" :key="index">
